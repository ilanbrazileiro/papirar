        ...
        <div class="row g-3">
            ...
            <div class="col-md-7">
                <div class="mb-3">
                    ...
                    <textarea name="short_description" id="short_description" class="form-control" rows="3" maxlength="255" placeholder="Ex.: Curso completo para treinar questões com simulados, comentários e acompanhamento de desempenho.">{{ old('short_description', $course->short_description ?? '') }}</textarea>
                ...
                <div class="mt-3">
                    ...
                    <input type="text" name="sales_headline" id="sales_headline" class="form-control" value="{{ old('sales_headline', $course->sales_headline ?? '') }}" maxlength="180" placeholder="Ex.: Treine com foco no seu concurso.">
                ...
                <div class="row g-3 mt-1">
                    <div class="col-md-6">
                        ...
                        <input type="text" name="target_audience" id="target_audience" class="form-control" value="{{ old('target_audience', $course->target_audience ?? '') }}" maxlength="180">
                    </div>
            ...
            <div class="col-12">
                ...
                <div class="text-muted small mt-1">Use um benefício por linha.</div>
            </div>
        </div>
    </div>
</div>
