...
<div class="container-fluid">
    ...
    <div class="card">
        <div class="card-header p-0 border-bottom-0">
            <ul class="nav nav-tabs" id="question-import-tabs" role="tablist">
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ old('csv_content') ? '' : 'active' }}" id="file-tab" data-bs-toggle="tab" data-bs-target="#file-pane" type="button" role="tab" aria-controls="file-pane" aria-selected="{{ old('csv_content') ? 'false' : 'true' }}">
                        Enviar arquivo CSV
                    </button>
                </li>
                <li class="nav-item" role="presentation">
                    <button class="nav-link {{ old('csv_content') ? 'active' : '' }}" id="paste-tab" data-bs-toggle="tab" data-bs-target="#paste-pane" type="button" role="tab" aria-controls="paste-pane" aria-selected="{{ old('csv_content') ? 'true' : 'false' }}">
                        Colar linhas CSV
                    </button>
                </li>
            </ul>
        ...
        <div class="card-body">
            <div class="tab-content" id="question-import-tabs-content">
                <div class="tab-pane fade {{ old('csv_content') ? '' : 'show active' }}" id="file-pane" role="tabpanel" aria-labelledby="file-tab" tabindex="0">
                ...
                <div class="tab-pane fade {{ old('csv_content') ? 'show active' : '' }}" id="paste-pane" role="tabpanel" aria-labelledby="paste-tab" tabindex="0">
