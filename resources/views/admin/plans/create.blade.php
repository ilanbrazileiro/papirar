...
<div class="card-soft p-4">
    <h1 class="page-title mb-4">Novo plano</h1>
    ...
    <form method="POST" action="{{ route('admin.plans.store') }}">
        ...
        <div class="row g-3">
            ...
            <div class="col-md-6">
                ...
                <small class="text-muted">Ex.: mensal, anual, teste-7-dias, liberacao-manual</small>
            </div>
            ...
            <div class="col-md-6">
                ...
                <input class="form-control" name="duration_days" value="{{ old('duration_days', 30) }}" required>
            </div>
